...
class m160325_143610_add_eav_permissions extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->insert('auth_item_child', ['parent' => 'administrator', 'child' => 'viewEavRecords']);
        $this->insert('auth_item_child', ['parent' => 'administrator', 'child' => 'editEavRecords']);
        $this->insert('auth_item_child', ['parent' => 'administrator', 'child' => 'createEavRecords']);
        $this->insert('auth_item_child', ['parent' => 'administrator', 'child' => 'deleteEavRecords']);
    }
